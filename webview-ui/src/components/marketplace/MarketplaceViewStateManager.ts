 ...
 *
 * This class manages the state for the marketplace view in the Echo AI extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Echo AI extensions interface
...
import { MarketplaceItem } from "@echo-ai/types"
