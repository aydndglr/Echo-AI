...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@echo-ai/types"
...
import { TOOL_GROUPS } from "@echo/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.echo/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
												...
												span: (
													<span
														...
														onClick={() => {
															...
															vscode.postMessage({
																type: "openFile",
																text: `./.echo/system-prompt-${currentMode.slug}`,
																values: {
																	create: true,
																	content: "",
																},
