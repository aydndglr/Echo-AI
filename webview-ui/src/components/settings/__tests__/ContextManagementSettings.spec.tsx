...
describe("ContextManagementSettings", () => {
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.echoignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.echoignore.description")).toBeInTheDocument()
		})
