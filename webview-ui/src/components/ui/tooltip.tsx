		...
		<TooltipPrimitive.Portal>
			<TooltipPrimitive.Content
				...
				className={cn(
					...
					"max-w-[300px] wrap-break-word",
					"shadow-[0_2px_8px_var(--color-vscode-widget-shadow)]",
					className,
				)}
				{...props}>
				{children}
				<TooltipPrimitive.Arrow className="bg-vscode-editorHoverWidget-background border-b border-r border-vscode-editorHoverWidget-border fill-vscode-editorHoverWidget-background z-50 size-1.5 translate-y-[calc(-50%+1px)] rotate-45" />
			</TooltipPrimitive.Content>
		</TooltipPrimitive.Portal>
	)
}
