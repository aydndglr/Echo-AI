...
import { ExtensionMessage, ExtensionState, MarketplaceInstalledMetadata, Command } from "@echo/ExtensionMessage"
import { findLastIndex } from "@echo/array"
import { McpServer } from "@echo/mcp"
import { checkExistKey } from "@echo/checkExistApiConfig"
import { Mode, defaultModeSlug, defaultPrompts } from "@echo/modes"
import { CustomSupportPrompts } from "@echo/support-prompt"
import { experimentDefault } from "@echo/experiments"
import { RouterModels } from "@echo/api"
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		showRooIgnoredFiles: true, // Default to showing .echoignore'd files with lock symbol (current behavior).
	...
	useEffect(() => {
		...
		if (!prevCloudIsAuthenticated && currentAuth && currentProvider === "echo") {
			// User just authenticated and Roo is the active provider - refresh Roo models
			vscode.postMessage({ type: "requestDevlogModels" })
		}
