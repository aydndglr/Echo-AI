...
export enum ExtensionBridgeEventName {
	TaskCreated = EchoCodeEventName.TaskCreated,
	TaskStarted = EchoCodeEventName.TaskStarted,
	TaskCompleted = EchoCodeEventName.TaskCompleted,
	TaskAborted = EchoCodeEventName.TaskAborted,
	TaskFocused = EchoCodeEventName.TaskFocused,
	TaskUnfocused = EchoCodeEventName.TaskUnfocused,
	TaskActive = EchoCodeEventName.TaskActive,
	TaskInteractive = EchoCodeEventName.TaskInteractive,
	TaskResumable = EchoCodeEventName.TaskResumable,
	TaskIdle = EchoCodeEventName.TaskIdle,

	TaskPaused = EchoCodeEventName.TaskPaused,
	TaskUnpaused = EchoCodeEventName.TaskUnpaused,
	TaskSpawned = EchoCodeEventName.TaskSpawned,

	TaskUserMessage = EchoCodeEventName.TaskUserMessage,

	TaskTokenUsageUpdated = EchoCodeEventName.TaskTokenUsageUpdated,

	ModeChanged = EchoCodeEventName.ModeChanged,
	ProviderProfileChanged = EchoCodeEventName.ProviderProfileChanged,
...
export enum TaskBridgeEventName {
	Message = EchoCodeEventName.Message,
	TaskModeSwitched = EchoCodeEventName.TaskModeSwitched,
	TaskInteractive = EchoCodeEventName.TaskInteractive,
}
