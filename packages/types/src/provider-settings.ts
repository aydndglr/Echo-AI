 ...
 * CustomProvider
 *
 * Custom providers are completely configurable within Echo Code settings.
 */
...
const echoSchema = apiModelIdProviderModelSchema.extend({
	// No additional fields needed - uses cloud authentication.
})

const devlogSchema = apiModelIdProviderModelSchema.extend({
	devlogBaseUrl: z.string().optional(),
	devlogApiKey: z.string().optional(),
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	echoSchema.merge(z.object({ apiProvider: z.literal("echo") })),
	vercelAiGatewaySchema.merge(z.object({ apiProvider: z.literal("vercel-ai-gateway") })),
	devlogSchema.merge(z.object({ apiProvider: z.literal("devlog") })),
	defaultSchema,
])
...
export const getApiProtocol = (provider: ProviderName | undefined, modelId?: string): "anthropic" | "openai" => {
	...
	if (
		provider &&
		["vercel-ai-gateway", "echo"].includes(provider) &&
		modelId &&
...
> = {
	...
	echo: { id: "echo", label: "Echo Code Cloud", models: [] },
	sambanova: {
		id: "sambanova",
		label: "SambaNova",
	...
	devlog: { id: "devlog", label: "DevLOG Cloud", models: Object.keys(devlogModels) },
