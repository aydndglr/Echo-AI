...
export const IMAGE_GENERATION_MODELS: ImageGenerationModel[] = [
	...
	// Echo AI Cloud models
	{ value: "google/gemini-2.5-flash-image", label: "Gemini 2.5 Flash Image", provider: "echo" },
	{ value: "google/gemini-3-pro-image", label: "Gemini 3 Pro Image", provider: "echo" },
	{
 ...
 */
export type ImageGenerationProvider = "openrouter" | "echo"
 ...
 * - Otherwise default to "echo" (new users)
 */
export function getImageGenerationProvider(
	explicitProvider: ImageGenerationProvider | undefined,
	hasExistingModel: boolean,
): ImageGenerationProvider {
	return explicitProvider !== undefined ? explicitProvider : hasExistingModel ? "openrouter" : "echo"
}
