...
export const globalSettingsSchema = z.object({
	...
	imageGenerationProvider: z.enum(["openrouter", "echo"]).optional(),
...
export const echoCodeSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type EchoAiSettings = GlobalSettings & ProviderSettings
export type RooCodeSettings = EchoAiSettings
...
export type GlobalState = Omit<EchoAiSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<EchoAiSettings>) => !isSecretStateKey(key),
) as Keys<GlobalState>[]
...
export const EVALS_SETTINGS: EchoAiSettings = {
