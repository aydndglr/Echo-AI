...
This package provides IPC functionality for Echo AI, allowing external applications to communicate with the extension through a socket-based interface.
...
```typescript
import { IpcClient } from "@echo-ai/ipc"
