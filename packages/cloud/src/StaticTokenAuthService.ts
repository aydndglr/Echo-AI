...
import type { JWTPayload, CloudUserInfo, AuthService, AuthServiceEvents, AuthState } from "@echo-ai/types"
...
export class StaticTokenAuthService extends EventEmitter<AuthServiceEvents> implements AuthService {
	...
	public async getOrganizationMemberships(): Promise<import("@echo-ai/types").CloudOrganizationMembership[]> {
		throw new Error("Authentication methods are disabled in StaticTokenAuthService")
	}
