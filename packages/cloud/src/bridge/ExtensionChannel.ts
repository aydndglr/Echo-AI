...
> {
	...
	private eventListeners: Map<EchoCodeEventName, (...args: unknown[]) => void> = new Map()
	...
	private setupListeners(): void {
		const eventMapping = [
			{ from: EchoCodeEventName.TaskCreated, to: ExtensionBridgeEventName.TaskCreated },
			{ from: EchoCodeEventName.TaskStarted, to: ExtensionBridgeEventName.TaskStarted },
			{ from: EchoCodeEventName.TaskCompleted, to: ExtensionBridgeEventName.TaskCompleted },
			{ from: EchoCodeEventName.TaskAborted, to: ExtensionBridgeEventName.TaskAborted },
			{ from: EchoCodeEventName.TaskFocused, to: ExtensionBridgeEventName.TaskFocused },
			{ from: EchoCodeEventName.TaskUnfocused, to: ExtensionBridgeEventName.TaskUnfocused },
			{ from: EchoCodeEventName.TaskActive, to: ExtensionBridgeEventName.TaskActive },
			{ from: EchoCodeEventName.TaskInteractive, to: ExtensionBridgeEventName.TaskInteractive },
			{ from: EchoCodeEventName.TaskResumable, to: ExtensionBridgeEventName.TaskResumable },
			{ from: EchoCodeEventName.TaskIdle, to: ExtensionBridgeEventName.TaskIdle },
			{ from: EchoCodeEventName.TaskPaused, to: ExtensionBridgeEventName.TaskPaused },
			{ from: EchoCodeEventName.TaskUnpaused, to: ExtensionBridgeEventName.TaskUnpaused },
			{ from: EchoCodeEventName.TaskSpawned, to: ExtensionBridgeEventName.TaskSpawned },
			{ from: EchoCodeEventName.TaskUserMessage, to: ExtensionBridgeEventName.TaskUserMessage },
			{ from: EchoCodeEventName.TaskTokenUsageUpdated, to: ExtensionBridgeEventName.TaskTokenUsageUpdated },
		] as const
