...
import type { ProviderName } from "@echo-ai/types"
import { devlogDefaultModelId, devlogModels, modelInfoSchema, TelemetryEventName } from "@echo-ai/types"
...
async function fetchModelsFromProvider(options: GetModelsOptions): Promise<ModelRecord> {
	...
	switch (provider) {
		...
		case "huggingface":
			...
			break
		case "echo": {
			// Echo AI Cloud provider requires baseUrl and optional apiKey
