...
import type { ProviderSettings, ModelInfo, ToolProtocol } from "@echo-ai/types"
...
// Yeni DevLog Provider import edildi
import { DevLogProvider } from "./providers/devlog"
...
export function buildApiHandler(configuration: ProviderSettings): ApiHandler {
    ...
    switch (apiProvider) {
        ...
        case "devlog":
            // Yeni DevLOG Cloud entegrasyonu
            return new DevLogProvider(options)
        case "featherless":
