...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .echo/rules-code/AGENTS.md (relative to project root)
       - .echo/rules-debug/AGENTS.md (relative to project root)
       - .echo/rules-ask/AGENTS.md (relative to project root)
       - .echo/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .echorules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .echo/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .echo folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .echo/rules-code/AGENTS.md (create .echo in project root, not system root!)
    - .echo/rules-debug/AGENTS.md (relative to project root)
    - .echo/rules-ask/AGENTS.md (relative to project root)
    - .echo/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .echo directory must be created in the current project/workspace root directory,
    ...
    ├── .echo/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .echo/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .echo/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .echo/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .echo/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
