...
import { getGlobalEchoDirectory, getProjectEchoDirectoryForCwd } from "../echo-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalEchoDirectory(), "commands")
	...
	const projectDir = path.join(getProjectEchoDirectoryForCwd(cwd), "commands")
