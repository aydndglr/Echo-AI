 ...
 * ```
 */
export function getProjectEchoDirectoryForCwd(cwd: string): string {
	return path.join(cwd, ".echo")
}
 ...
 * ```
 */
export function getEchoDirectoriesForCwd(cwd: string): string[] {
	const directories: string[] = []

	// Add global directory first
	directories.push(getGlobalEchoDirectory())

	// Add project-local directory second
	directories.push(getProjectEchoDirectoryForCwd(cwd))
...
export async function loadConfiguration(
	...
	const globalDir = getGlobalEchoDirectory()
	const projectDir = getProjectEchoDirectoryForCwd(cwd)
...
export const loadEchoConfiguration: typeof loadConfiguration = loadConfiguration
