...
import {
	getGlobalEchoDirectory,
	getProjectEchoDirectoryForCwd,
	directoryExists,
	fileExists,
	readFileIfExists,
	getEchoDirectoriesForCwd,
	loadConfiguration,
} from "../index"
...
describe("RooConfigService", () => {
	...
	describe("getGlobalRooDirectory", () => {
		it("should return correct path for global .roo directory", () => {
			const result = getGlobalEchoDirectory()
	...
	describe("getProjectRooDirectoryForCwd", () => {
		it("should return correct path for given cwd", () => {
			...
			const result = getProjectEchoDirectoryForCwd(cwd)
	...
	describe("getRooDirectoriesForCwd", () => {
		it("should return directories for given cwd", () => {
			...
			const result = getEchoDirectoriesForCwd(cwd)
