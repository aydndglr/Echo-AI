...
import { CodeActionName, CodeActionId } from "@echo-ai/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Echo AI",
	FIX: "Fix with Echo AI",
	IMPROVE: "Improve with Echo AI",
	ADD_TO_CONTEXT: "Add to Echo AI",
	NEW_TASK: "New Echo AI Task",
} as const
