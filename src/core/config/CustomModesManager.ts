...
import { type ModeConfig, type PromptComponent, customModesSettingsSchema, modeConfigSchema } from "@echo-ai/types"
...
export class CustomModesManager {
	...
	private async getWorkspaceEchomodes(): Promise<string | undefined> {
