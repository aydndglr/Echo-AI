...
import { isLanguage } from "@echo-ai/types"

import type { SystemPromptSettings } from "../types"
import { getEffectiveProtocol, isNativeProtocol } from "@echo-ai/types"

import { LANGUAGES } from "../../../shared/language"
import { getEchoDirectoriesForCwd, getGlobalEchoDirectory } from "../../../services/echo-config"
...
export async function loadRuleFiles(cwd: string): Promise<string> {
	const rules: string[] = []
	const rooDirectories = getEchoDirectoriesForCwd(cwd)
