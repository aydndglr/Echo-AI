...
import { useRooCodeCloudModels } from "@/hooks/use-echo-ai-cloud-models"
...
export function NewRun() {
	...
	const [provider, setModelSource] = useState<"echo" | "openrouter" | "other">("echo")
				...
				<form
					...
					<FormField
						...
						render={() => (
							<FormItem>
								<Tabs
									value={provider}
									onValueChange={(value) => setModelSource(value as "echo" | "openrouter" | "other")}>
									<TabsList className="mb-2">
										<TabsTrigger value="echo">Echo AI Cloud</TabsTrigger>
					...
					{provider === "echo" && (
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>Echo AI Cloud Token</FormLabel>
									<FormControl>
										<Input type="password" {...field} />
									</FormControl>
									<FormMessage />
									<FormDescription>
										If you have access to the Echo AI Cloud repository then you can generate a
										token with:
										<br />
										<code className="text-xs">
											pnpm --filter @echo-ai-cloud/auth production:create-job-token [org]
											[timeout]
										</code>
									</FormDescription>
								</FormItem>
