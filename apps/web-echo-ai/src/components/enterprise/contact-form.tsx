...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Echo AI's enterprise solution."
			: "Fill out the form below to see Echo AI's enterprise capabilities in action."
