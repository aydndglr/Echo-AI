...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Echo AI?",
		answer: (
			<>
				Echo AI is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Echo AI differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Echo AI is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: Echo AI is{" "}
	...
	{
		question: "Is Echo AI really free?",
		answer: (
			<>
				Yes! Echo AI is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Echo AI is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .echoignore to exclude sensitive files, and you can also run Echo AI with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Echo AI support?",
		answer: (
			<>
				Echo AI is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows Echo AI&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does Echo AI support my programming language?",
		answer: (
			<>
				Likely yes! Echo AI supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Echo AI uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Echo AI for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Echo AI was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because Echo AI is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can Echo AI run commands and tests automatically?",
		answer: (
			<>
				Yes! One of Echo AI&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				Echo AI shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to Echo AI?",
		answer: (
			<>
				Yes, please do! Echo AI is open-source on{" "}
				<a
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Echo AI and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
