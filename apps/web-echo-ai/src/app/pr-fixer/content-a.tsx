...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			"Echo AI's PR Fixer applies high-quality changes to your PRs, right from GitHub. Invoke via a PR comment and it will read the entire comment history to understand context, agreements, and tradeoffs — then implement the right fix.",
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					'Ask the agent to fix issues directly from GitHub PR comments (e.g. "@echomote: fix these review comments"). It\'s fully aware of the entire comment history and latest diffs and focuses on fixing them – not random changes to your code.',
	...
	whyBetter: {
		heading: "Why Echo AI's PR Fixer is different",
		features: [
			{
	...
	cta: {
		...
		description: "Let Echo AI's PR Fixer turn your review feedback into clean, ready-to-merge commits.",
		buttonText: "Start 14-day Free Trial",
	},
}
