...
const faqs = [
	...
	{
		question: "What is the Echo AI Cloud Provider?",
		answer: (
			<>
				<p>This is our very own model provider, optimized to work seamlessly with Echo AI Cloud.</p>
				<p>
	...
	{
		question: "But how much does the Echo AI Cloud service cost?",
		answer: (
			<>
				Our{" "}
				...
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-4xl md:text-5xl font-bold tracking-tight">
							Echo AI Cloud Provider Pricing
						</h1>
