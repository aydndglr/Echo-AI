...
const TITLE = "Echo AI Cloud Pricing"
const DESCRIPTION =
	"Simple, transparent pricing for Echo AI Cloud. The VS Code extension is free forever. Choose the cloud plan that fits your needs."
...
const pricingTiers: PricingTier[] = [
	{
		...
		features: [
			...
			"Access to the Echo AI Cloud Provider, including early access to free stealth models",
		...
		<>
			...
			<section className="relative overflow-hidden pt-16 pb-12">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-5xl font-bold tracking-tight">Echo AI Cloud Pricing</h1>
			...
			<div className="mx-6 md:mx-auto max-w-6xl">
				<div className="rounded-xl p-4 mb-8 text-center bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-purple-500/10 border border-blue-500/20 dark:border-white/20 ">
					<p className="text-center">
						<strong className="font-semibold">The Echo AI extension is totally free! </strong>
			...
			<div className="mx-6 md:mx-auto max-w-6xl p-7 mb-4 relative flex flex-col justify-start bg-background border rounded-2xl transition-all shadow-none hover:shadow-lg">
				...
				<div className="text-sm text-muted-foreground space-y-1 mt-2">
					<p className="">
						On any plan, you can bring your own provider key or use the built-in Echo AI Cloud provider.
					</p>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
						<div className="rounded-xl border border-border bg-card p-6">
							<h3 className="font-semibold">Wait, is Echo AI free or not?</h3>
							<p className="mt-2 text-sm text-muted-foreground">
								Yes! The Echo AI VS Code extension is open source and free forever. The extension acts
						...
						<div className="rounded-xl border border-border bg-card p-6">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Echo AI Cloud credits can be used in two ways:
							</p>
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-purple-500/5 p-8 text-center shadow-2xl backdrop-blur-xl dark:border-white/20 dark:bg-gradient-to-br dark:from-gray-800 dark:via-gray-900 dark:to-black sm:p-12">
						<h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Try Echo AI Cloud now</h2>
