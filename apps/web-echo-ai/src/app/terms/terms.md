# Echo AI Cloud Terms of Service

_(Version 1.1 – Effective Oct 16, 2025)_

These Terms of Service ("**TOS**") govern access to and use of the Echo AI Cloud service (the "**Service**"). They apply to:

- **(a)** every **Sales Order Form** or similar document mutually executed by Echo AI and the customer that references these TOS; **and**
...
If Echo AI and Customer later execute a Master Subscription Agreement ("**MSA**"), the MSA governs; otherwise, these TOS and the applicable Order Form together form the entire agreement (the "**Agreement**").
...
| Security Standard                 | Echo AI is SOC2 Type 2 compliant and follows industry-standard security practices.                                                                                                               |
| Machine-Learning Use              | Echo AI **does not** use Customer Content to train, fine-tune, or improve any ML or AI models.                                                                                                   |
...
| Publicity / Logo Rights           | Echo AI may identify Customer (name & logo) in marketing materials unless Customer opts out in writing.                                                                                          |
...
5. **Sections 7 (Trials / Betas) and any SLA references.**  
   Deleted – Echo AI offers no pilots, betas, or SLA credits under these TOS.
...
Echo AI's Privacy Notice ([https://roocode.com/privacy](https://roocode.com/privacy)) explains how Echo AI collects and handles personal information. If Customer requires a DPA, email [support@echocode.com](mailto:support@echocode.com).
...
1. **Assignment.**  
   Customer may not assign the Agreement without Echo AI's prior written consent, except to a successor in a merger or sale of substantially all assets.
...
4. **Amendments.**  
   Echo AI may update these TOS by posting a revised version at the same URL and emailing or in-app notifying Customer at least 30 days before changes take effect. Continued use after the effective date constitutes acceptance.

## 10. Contact

**Echo AI, Inc.**  
98 Graceland Dr, San Rafael, CA 94901 USA  
Email: [support@echocode.com](mailto:support@echocode.com)
