...
const DESCRIPTION =
	"Privacy policy for Echo AI Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Echo AI Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Echo AI, Inc. (&quot;Echo AI,&quot; &quot;we,&quot;
						&quot;our,&quot; or &quot;us&quot;) collects, uses, and shares information when you:
					</p>
					<ul className="lead">
						<li>
							browse any page under <strong>devlog.tr</strong> (the <em>Marketing Site</em>); and/or
						</li>
						<li>
							create an account for, sign in to, or otherwise use <strong>Echo AI Cloud</strong> at{" "}
							<strong>app.roocode.com</strong> or through the Echo AI extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Echo AI extension <strong>without</strong> connecting to a Cloud account,
							...
							<a
								...
								Echo AI Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit Echo AI servers unless you explicitly choose Echo AI
								as a model provider (proxy mode).
							</strong>{" "}
							When Echo AI Cloud is your model provider, your code briefly transits Echo AI servers only
							...
							TLS—to the model you select. Echo AI never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Echo AI Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Echo AI Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Echo AI Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or Echo AI (proxy
										mode; transit‑only) when you select Echo AI as the provider
									</td>
									<td className="border border-border px-4 py-2">
										Echo AI servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Echo AI Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Echo AI servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Echo AI servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Echo AI Cloud.
						</li>
						<li>
					...
					<p>
						...
						<a href="mailto:privacy@echocode.com" className="text-primary hover:underline">
							privacy@echocode.com
						</a>
						.
					</p>
				</div>
