...
const TITLE = "Echo AI Cloud"
const DESCRIPTION =
	"Echo AI Cloud gives you and your team the tools to take AI-coding to the next level with cloud agents, remote control, and more."
						...
						<div className="flex flex-col px-4 justify-center space-y-6 sm:space-y-8">
							<div>
								...
								<p className="mt-4 max-w-md text-lg text-muted-foreground text-center md:text-left sm:mt-6">
									Echo AI Cloud gives you (and your team) the tools to take AI-coding to the next
									level
								</p>
							</div>
						...
						<div className="flex items-center justify-end mx-auto h-full mt-8 lg:mt-0">
							<div className="md:w-[900px] md:h-[700px] relative rounded-md overflow-clip">
								<div className="block">
									<Image
										src={screenshotDark}
										alt="Screenshot of Echo AI Cloud"
